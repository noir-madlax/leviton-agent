...
SAMPLE_PRODUCTS = [
    ...
    ProductData(product_id="11", title="Treatlife Smart Light Switch Alexa Google Home"),
    ProductData(product_id="12", title="Eaton Wiring Device Traditional Toggle Switch"),
    ProductData(product_id="13", title="Wyze Smart Light Switch WiFi Enabled"),
    ProductData(product_id="14", title="Cooper Wiring Devices Standard Wall Switch"),
    ProductData(product_id="15", title="Jasco Z-Wave Plus Smart In-Wall Switch")
] 