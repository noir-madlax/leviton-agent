#!/usr/bin/env python3
"""
Improved product details extraction with intelligent column merging using heuristics.
Features:
- Pattern-based column matching instead of hardcoded rules
- Unit preservation for numerical values
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('extraction_log_v3.txt'),
...
class IntelligentColumnMerger:
    ...
    def merge_column_values(self, val1: Any, val2: Any) -> Tuple[Any, bool]:
        """Merge two column values, preserving units and handling conflicts."""
...
class ProductDetailsExtractorV3:
    def __init__(self):
    ...
    def merge_similar_columns(self, df: pd.DataFrame) -> pd.DataFrame:
        """Merge similar columns using intelligent heuristics."""
    ...
    def generate_reports(self, df: pd.DataFrame, output_dir: str = '.'):
        ...
        # Save main CSV
        csv_path = os.path.join(output_dir, 'extracted_product_details_v3.csv')
        ...
        conflict_path = os.path.join(output_dir, 'conflict_report_v3.json')
        ...
        # Save statistics
        stats_path = os.path.join(output_dir, 'extraction_statistics_v3.json')
...
def main():
    ...
    logging.info("Starting intelligent product details extraction...")
    
    # Initialize extractor
    extractor = ProductDetailsExtractorV3()
